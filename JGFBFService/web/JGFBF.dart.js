...
$.main = function() {
  $.HttpRequest_HttpRequest$get("http://localhost:3031/service/JGFBFTwitter.svc/TestInterface/TestContract", $.onSuccess);
};

$.onSuccess = function(request) {
  var data = $.JSON_parse(request.get$responseText());
  $.query("#text").set$text(data);
};
...
// 15 !leaf
(function() {
  var v0_MediaElement = 'HTMLMediaElement|HTMLVideoElement|HTMLAudioElement', v1_Element = [v0_MediaElement, 'Element|HTMLUListElement|HTMLUnknownElement|SVGElement|SVGAElement|SVGAltGlyphDefElement|SVGTextContentElement|SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement|SVGTextPathElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGCircleElement|SVGClipPathElement|SVGComponentTransferFunctionElement|SVGFEFuncRElement|SVGFEFuncAElement|SVGFEFuncGElement|SVGFEFuncBElement|SVGDefsElement|SVGEllipseElement|SVGFEBlendElement|SVGFEComponentTransferElement|SVGFEConvolveMatrixElement|SVGFEDisplacementMapElement|SVGDescElement|SVGFEDropShadowElement|SVGFEDiffuseLightingElement|SVGFEDistantLightElement|SVGFECompositeElement|SVGFEMorphologyElement|SVGCursorElement|SVGFEPointLightElement|SVGFETileElement|SVGFilterElement|SVGFEColorMatrixElement|SVGFEFloodElement|SVGFontFaceNameElement|SVGFontFaceFormatElement|SVGFETurbulenceElement|SVGFEGaussianBlurElement|SVGFEImageElement|SVGFEMergeElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGFontFaceElement|SVGForeignObjectElement|SVGGElement|SVGFESpecularLightingElement|SVGFESpotLightElement|SVGLineElement|SVGFEMergeNodeElement|SVGFontElement|SVGMaskElement|SVGMarkerElement|SVGGlyphRefElement|SVGFontFaceSrcElement|SVGFontFaceUriElement|SVGFEOffsetElement|SVGHKernElement|SVGImageElement|SVGPathElement|SVGMissingGlyphElement|SVGMPathElement|SVGGlyphElement|SVGPatternElement|SVGMetadataElement|SVGPolygonElement|SVGPolylineElement|SVGRectElement|SVGScriptElement|SVGStopElement|SVGStyleElement|SVGSwitchElement|SVGSymbolElement|SVGSVGElement|SVGTitleElement|SVGUseElement|SVGVKernElement|SVGViewElement|HTMLElement|HTMLAnchorElement|HTMLAppletElement|HTMLAreaElement|HTMLBRElement|HTMLBaseElement|HTMLBaseFontElement|HTMLButtonElement|HTMLBodyElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDirectoryElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFormElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement'].join('|'), v2_Document = 'Document|SVGDocument|HTMLDocument', v3_DocumentFragment = 'DocumentFragment|ShadowRoot', v4_CharacterData = 'CharacterData|Text|CDATASection|Comment', v5_Node = [v1_Element, v2_Document, v3_DocumentFragment, v4_CharacterData, 'Node|DocumentType|EntityReference|Attr|Notation|ProcessingInstruction'].join('|');
  $.dynamicSetMetadata([['CharacterData', v4_CharacterData], ['HTMLMediaElement', v0_MediaElement], ['Element', v1_Element], ['Uint8Array', 'Uint8Array|Uint8ClampedArray'], ['Document', v2_Document], ['DocumentFragment', v3_DocumentFragment], ['Node', v5_Node], ['EventTarget', [v5_Node, 'EventTarget|XMLHttpRequest|XMLHttpRequestUpload'].join('|')]]);
})();
...
//@ sourceMappingURL=JGFBF.dart.js.map